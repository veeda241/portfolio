...
const Achievements: React.FC = () => {
  ...
  return (
    <SectionWrapper id="achievements" ref={sectionRef}>
      <AnimatedSectionTitle label="// highlights" title="Achievements" />
        ...
        <TimelineSVG ref={timelineRef} viewBox="0 0 600 24">
          ...
          {items.map((_, i) => (
            <circle
              ...
              r="0"
              fill={
                typeConfig[_.type]?.color || '#90ee90'
              }
            />
          ))}
        </TimelineSVG>
